...
<body>
    ...
    if (isset($_GET['postId'])) {
        ...
        $post = mysqli_query($db, "SELECT* FROM posts WHERE id=$postId_to_update");
                    ...
                    <form method="POST" action="post-edit.php">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="post_id" value="<?php echo $postId_to_update; ?>">
                                <label>Title</label>
                        ...
                        <div class="card-footer"><button class="btn btn-primary" name="update_post_button" type="submit">Update</button></div>
